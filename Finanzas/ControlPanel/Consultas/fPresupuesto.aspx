<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="fPresupuesto.aspx.cs" Inherits="Finanzas.ControlPanel.Consultas.fPresupuesto" %>
        ...
        <div class="container">
                    ...
                    <asp:TextBox ID="TbBuscar" class="form-control" runat="server" placeholder="Texto"></asp:TextBox>
                        ...
                        <td>
                            <asp:DropDownList ID="TipoDropDownList" Class="form-control" runat="server">
                                <asp:ListItem>IdPresupuesto</asp:ListItem>
            ...
            <div>
                <asp:GridView ID="GridViewVista" class="scroll" runat="server" Width="84%" height="100%" BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" CellPadding="4" GridLines="Horizontal">
                    <Columns>
                        <asp:HyperLinkField DataNavigateUrlFields="IdPresupuesto" DataNavigateUrlFormatString="~/ControlPanel/Registros/rPresupuesto.aspx?IdPresupuesto={0}" Text="Editar" />
                    </Columns>
