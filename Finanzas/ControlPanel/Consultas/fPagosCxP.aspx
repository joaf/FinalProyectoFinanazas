<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="fPagosCxP.aspx.cs" Inherits="Finanzas.ControlPanel.Consultas.fPagosCxP" %>
        ...
        <div class="container">
            ...
            <div>
                <asp:GridView ID="GridViewVista" class="scroll" runat="server" Width="84%" height="100%" BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" CellPadding="4" GridLines="Horizontal">
                    <Columns>
                        <asp:HyperLinkField DataNavigateUrlFields="IdPago" DataNavigateUrlFormatString="~/ControlPanel/Registros/rPagosCxP.aspx?IdPago={0}" Text="Editar" />
                    </Columns>
